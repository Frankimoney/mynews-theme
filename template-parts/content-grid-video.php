<?php
/**
 * Template part for displaying video format posts in grid layout
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class('card h-100 border-0 shadow-sm format-video'); ?>>
    <div class="card-video-container">
        ...
        if (!empty($media)) {
            // We found a video, but in grid view we'll just show the thumbnail with play button
            $video_found = true;
        } 
        // Check for video URL if no embedded video
        else {
        ...
        // For grid layout, we always display the thumbnail with a play button overlay
